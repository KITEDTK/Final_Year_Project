...
CREATE TABLE [dbo].[Users] (
    ...
    [point] INT CONSTRAINT [Users_point_df] DEFAULT 0,
    [verifyToken] NVARCHAR(1000),
    [expiredTokenTime] DATETIME2,
    [createAt] DATETIME2 CONSTRAINT [Users_createAt_df] DEFAULT CURRENT_TIMESTAMP,
    [updateAt] DATETIME2,
    [isEnable] BIT CONSTRAINT [Users_isEnable_df] DEFAULT 1,
...
-- AddForeignKey
ALTER TABLE [dbo].[Carts] ADD CONSTRAINT [Carts_clothDetailId_fkey] FOREIGN KEY ([clothDetailId]) REFERENCES [dbo].[ClothDetails]([id]) ON DELETE NO ACTION ON UPDATE CASCADE;
